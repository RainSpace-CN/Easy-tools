...
import cn.rainspace.easytools.tileentity.ModTileEntityType;
...
public class EasyTools
{
    ...
    private void enqueueIMC(final InterModEnqueueEvent event)
    {
        ...
        InterModComms.sendTo("easytools", "helloworld", () -> { LOGGER.info("Hello world from the MDK"); return "Hello world";});
    }
